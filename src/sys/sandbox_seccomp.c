 ...
 * - Code can only write to file descriptor 1.
 *
 * Therefore:
 *
 ...
 * - Integrity: as long as there's no way to remap 1 to something other
 *   than STDOUT, should be fine. I don't know of one on Linux. Some
